...
function AddRecipeModal({open,onClose,onAdd,apiKey,onNeedKey}){
  ...
  const TPL='{"title":"TITULO","description":"DESCRIPCION breve","image":"https://URL-imagen-real-del-plato.jpg","mealType":"Comida","recipeType":"Otros platos","ingredients":[{"amount":"200","unit":"gramos","name":"ingrediente"}],"steps":["paso uno","paso dos"],"sourceUrl":"","time":"30 min","servings":4}';
