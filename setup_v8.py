#!/usr/bin/env python3
# setup_v8.py - Rewrite completo desde cero
...
jsx_part1 = r"""import { useState, useEffect, useRef } from "react";
...
jsx_part2 = f"""
const LOGO_IMG = "data:image/jpeg;base64,{LOGO_B64}";
...
# Fix the spread operator issue in jsx_part2
jsx_part2 = jsx_part2.replace('{{{...}id:', '{id:')

jsx = jsx_part1 + jsx_part2

with open("src/App.jsx","w",encoding="utf-8") as f:
    f.write(jsx)
print(f"OK: App.jsx v8 escrito ({len(jsx)} chars, {jsx.count(chr(10))} lineas)")
